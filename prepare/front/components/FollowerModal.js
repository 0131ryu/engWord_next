                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <p className="dark:text-white text-sm font-medium text-gray-900 truncate">
                                        {follower.nickname}
                                      </p>
                                                ...
                                                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                                  <div className="bg-light-beige p-1">
                                                    <button
                                                      ...
                                                      className="dark:text-black flow-root rounded-md px-2 py-2 transition duration-150 ease-in-out hover:bg-light-beige focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                                                    >
                                                      차단
                                                    </button>
                                                  </div>
